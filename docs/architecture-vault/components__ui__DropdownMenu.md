...
`src/components/ui/DropdownMenu.tsx` · **layer:** UI Primitives · **imported by 8** · **imports 0**

> [!warning] God node — high fan-in. Changes here ripple widely.

## Imports
- _none (leaf / external deps only)_

## Imported by
- [[pages__Companies|pages/Companies]]  _( Pages )_
- [[pages__Customers|pages/Customers]]  _( Pages )_
- [[pages__Expenses|pages/Expenses]]  _( Pages )_
- [[pages__Inventory|pages/Inventory]]  _( Pages )_
- [[pages__Suppliers|pages/Suppliers]]  _( Pages )_
- [[pages__Technicians|pages/Technicians]]  _( Pages )_
